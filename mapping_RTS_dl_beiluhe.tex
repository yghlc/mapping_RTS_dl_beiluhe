...
% Moreover, the RGB bands are natural and easier for manual identification. 

%After pre-processing, we obtained a single image as input for the automatic mapping method and collecting ground truth. 

%We utilized to pre-process all the PlanetScope Scenes. 

%For these 64 scenes,   ,  We also conduct a set of experiments to shows the results of other combination of bands (See section \ref{subsub_otherbands}). 
