...
The lower IOU values indicate that the mapped polygons match ground truths but not as well as the case in Beiluhe, as examples in Fig. S16a and b. 
The reason for the lower F1 score in the test area is that some of RTSs or land cover with different appearances on the images were not included in the Beiluhe training data. 
