...
Similar, their IOU values (a histogram in Fig. S17) are not as high as the ones in the study area.
...
The reason for the lower F1 score in the test area is that some of RTSs or land cover with different appearance on images were not included in the training data. %the image is different as well.
